...
public class AjouterPatientIU extends javax.swing.JFrame {
    ...
    public AjouterPatientIU() {
        ...
        jButtonAnnuler.addActionListener(apl);
        jButtonOK.addActionListener(apl);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AjouterPatientIU.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AjouterPatientIU().setVisible(true);
            }
        });
    }
